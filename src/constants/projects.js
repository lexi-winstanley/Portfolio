    ...
    projects: [
        {
            ...
            technicalInfo: 'The client, a home builder in Fargo, ND, wanted to refresh their current website. The design needed to be responsive and allow for many pictures of the company\'s various floor plans so React was a natural choice to help improve performance. The company also has a modern aesthetic and wanted this to be reflected in the design of the new site. Adobe Illustrator and InVision were used to create several home page mocks that were discussed with the client before creating a full site mock up. During the design phase the client\'s existing logo was used as color inspiration and additional custom graphics were created to be used in the site which complemented the logo. After the client signed off on the full site mock, development began using React to realize the vision. The client provided access to photos with Dropbox which were moved to Amazon S3 for use in the site. A test site was provided after initial development and discussed with the client so any change requests could be incorporated into the final site.',
            technologies: 'HTML, CSS, JavaScript, React, Amazon S3',
            npmPackages: '',
            futureDev: '',
            role: 'Co-owner and part of a two person development team at w-innovations, LLC. Responsible for design, creation of custom graphics, front end code and integration with back end. Also responsible for all client interactions and communicating client requirements and desires to back end developer.',
            githubLink: '',
            githubLink2: '',
        ...
        },
        {
            ...
            role: 'Technical lead of a three person development team. Collaborated with team members regarding application functionality and design. Helped team members as needed to deliver integration with Google Authentication, timer functionality and was responsible for all other code including the backend as well as styling to comply with agreed upon design. Also created custom component to handle pinch-to-zoom, pan and double tap actions during game play.',
            githubLink: 'https://github.com/lexi-winstanley/bri-SPY',
            githubLink2: 'https://github.com/lexi-winstanley/bri-SPYBackEnd',
            projectLink: '',
            javascript: true,
            node: true,
            jQuery: false,
        ...
        },
        {
            ...
            motivation: '',
            description: 'Three Score Development is a website for career and personal coaches Bill and Katie Morris. The site displays the available coaching offerings and allows people to schedule appointments with whichever coach best fits their unique situation.',
            technicalInfo: 'After hiring w-innovations, LLC to design and build a website for their first business, Three Score Rub, clients Katie and Bill Morris looked to us again for their new venture: Three Score Development. This website needed to display their coaching certifications and give perspective clients an idea of their individual skill sets and personal histories. The site also needed to integrate with Acuity Scheduling for clients to sign up for and purchase coaching packages or sessions. The design began with Adobe Illustrator and InVision to create several home page mocks that were discussed with the client before creating a full site mock up. The design phase included the development of a custom logo for the website which would also be used by the clients in business cards and other professional materials. After the client signed off on the full site mock, development began using HTML, ThymeLeaf and CSS. A test site was provided after initial development and discussed page by page with the clients after which change requests were incorporated into the final site.',
            technologies: 'HTML, ThymeLeaf, CSS, Acuity Scheduling integration and customization, Java',
            npmPackages: '',
            futureDev: '',
            role: 'Co-owner and part of a two person development team at w-innovations, LLC. Responsible for design, HTML/Thymeleaf, CSS, client interactions and creation of custom graphics. Also completed integration with Acuity Scheduling and customized appearance with CSS.',
            githubLink: '',
            githubLink2: '',
        ...
        },
        {
            ...
            path: '/chapter-too',
            motivation: '',
            description: 'Chapter Too is a travel blog which began with a focus on sailing the world with Blue Planet Odyssey. Over time the blog has been expanded to include the on land adventures of the couple as well. As a blogger, the client needed additional aspects to be addressed such as a way for them to easily add new content to the site.',
            technicalInfo: 'This client came to us looking for a custom blogging solution motivated by their desire to use their GPS device to send route data to be displayed on their site during their time with Blue Planet Odyssey sailing the world. The initial development of the site started with home page design mocks which were discussed with the clients before moving on to a full site mock. During this phase custom graphics were created for the site as well. Development began on the blog site as well as an auxiliary site for the client to use to add new blog entries, images and galleries to the site. The mapping feature was a unique challenge that involved extensive back end work and integration with Google Maps for display of the data. On the front end, I was responsible for designing an interface that would easily allow users to filter the displayed routes on the map. Unfortunately the clients have since decided they no longer need or want to display the route data from their initial travels but they continue to use the other aspects of the site to regularly share their adventures. ',
            technologies: 'HTML, CSS, Java',
            npmPackages: '',
            futureDev: '',
            role: 'Co-owner and part of a two person development team at w-innovations, LLC. Responsible for design, HTML/Thymeleaf and CSS, client interactions and creation of custom graphics.',
            githubLink: '',
            githubLink2: '',
        ...
        },
        {
            ...
            motivation: '',
            description: 'Three Score Rub is a barbecue rub line created by Bill Morris. The website offers cooking tips, recipes and an online store where visitors can purchase the rubs once available.',
            technicalInfo: 'The client wanted a website inspired by their existing logo where they could share not only information about the rubs themselves but also tips for using them and recipes where they were highlighted. Because the client did not yet have product to photograph during the initial development custom jar graphics were created using Adobe Illustrator to represent the rub flavors, but the client ended up really liking the aesthetic of the graphics and ultimately decided not to replace them! During the design phase I worked closely with the clients to design a full site mock using Adobe Illustrator which was iterated on during development as needed. The clients also requested the ability to add recipes to the site which was achieved using a secondary site where they can log in to add content. During development PayPal was integrated into the online store to allow for the handling of purchases but for now this feature has been turned off as the client decided to take a break for a few years to enjoy time with family and concentrate on his other business venture, Three Score Development.',
